...
public class ModbusRS485Connection implements ModbusConnection {
    ...
    public void CreateRS485Connection(String serialport, String baud, String parity, Integer databits, Integer stopbits) {
        try {
            ...
            params.setEcho(ModbusConnection.COMPORT_ECHO);
            params.setReceiveTimeout(ModbusConnection.COMPORT_RECEIVE_TIMEOUT);

            ModbusCoupler.getReference().setMaster(ModbusConnection.MASTER_UNIT);
            ModbusCoupler.getReference().setUnitID(ModbusConnection.MASTER_UNIT_ID);
