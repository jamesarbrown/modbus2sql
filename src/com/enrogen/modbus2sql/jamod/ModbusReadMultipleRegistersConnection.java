...
public class ModbusReadMultipleRegistersConnection implements appInterface {
    ...
    public void ExecuteTransaction(SerialConnection sc) {
        ...
        try {
            ...
            System.out.println("com.enrogen.ModbusConnection - Slave Exception : " + mse.getMessage());
